        ...
        <section>
            ...
            <div class="my-4">
                <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"
                    wire:click="create">Agregar Insumo a la compra</button>
            </div>
            <button wire:click="detalle1(444)">Test</button>
            @if ($isOpen)
                <div class=" flex overflow-auto relative left-0 right-0 inset-0 items-center justify-center z-50 ">
                    ...
                    <div class=" relative bg-gray-200 p-8 rounded shadow-lg w-1/2">
                        ...
                        <h2 class="text-2xl font-bold mb-4">{{ $ProveedorId ? 'Editar Proveedor' : 'Crear Proveedor' }}
                        </h2>
                        <form wire:submit.prevent="{{ $ProveedorId ? 'update' : 'store' }}">
                            <div class="mb-4">
                                <label for="nombre" class="block text-gray-700 font-bold mb-2">Nombre del
                                    Proveedor:</label>
                                ...
                                <select wire:model="ciudad" id="ciudad"
                                    class="w-full border border-gray-300 px-4 py-2 rounded">
                                    ...
                                    <input type="text" wire:model="ciudad" placeholder="Otra ciudad"
                                        class="w-full border border-gray-300 px-4 py-2 rounded">
                                </select>
                                ...
                                <input type="text" wire:model="fax" id="fax"
                                    class="w-full border border-gray-300 px-4 py-2 rounded">
                                <label for="nit" class="block text-gray-700 font-bold mb-2">NIT:</label>
                                <input type="number" wire:model="nit" id="nit"
                                    class="w-full border border-gray-300 px-4 py-2 rounded">
                                ...
                                <label for="persona_contacto" class="block text-gray-700 font-bold mb-2">Persona de
                                    contacto:</label>
                                <input type="text" wire:model="persona_contacto" id="persona_contacto"
                                    class="w-full border border-gray-300 px-4 py-2 rounded">
                                ...
                                <label for="representante"
                                    class="block text-gray-700 font-bold mb-2">Representante:</label>
